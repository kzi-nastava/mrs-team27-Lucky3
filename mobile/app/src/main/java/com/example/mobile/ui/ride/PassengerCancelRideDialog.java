...
public class PassengerCancelRideDialog extends DialogFragment {

    public static final String REQUEST_KEY = "passenger_cancel_ride_result";
    ...
    public static PassengerCancelRideDialog newInstance(long rideId) {
        PassengerCancelRideDialog dialog = new PassengerCancelRideDialog();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View root = LayoutInflater.from(requireContext())
                .inflate(R.layout.dialog_cancel_ride_passenger, null);
        ...
        btnConfirm.setOnClickListener(v -> {
            ...
            confirmCancel(rideId, reason.isEmpty() ? null : reason);
        });
    ...
    private void confirmCancel(long rideId, String reason) {
        ...
        RideCancellationRequest request = new RideCancellationRequest(reason != null ? reason : "");
                    ...
                    public void onResponse(Call<RideResponse> call, Response<RideResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (errorMsg != null) {
                                ...
                                showError("You may only cancel scheduled rides more than 10 minutes before start.");
                            }
                        }
                    }
